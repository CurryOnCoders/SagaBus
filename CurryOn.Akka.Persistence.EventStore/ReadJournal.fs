...
type EventStoreReadJournal (system: ExtendedActorSystem) =        
    inherit StreamingQueryReadJournalBase<EventStoreProvider>(system, system.Settings.Config.GetConfig(EventStoreReadJournal.Identifier), EventStoreJournal.Identifier)
