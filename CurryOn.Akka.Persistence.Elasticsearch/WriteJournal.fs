...
type ElasticsearchJournal (config: Config, context: IActorContext) = 
    static do EventJournal.register<ElasticsearchJournal> (fun config context -> ElasticsearchJournal(config, context) :> IEventJournal)
