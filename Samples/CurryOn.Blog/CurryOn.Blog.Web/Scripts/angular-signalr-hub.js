        ...
        return function (hubName, options) {
            ...
            Hub.connect = function (queryParams) {
                ...
                if (options.transport)
                    startOptions.transport = options.transport;
                if (options.jsonp)
                    startOptions.jsonp = options.jsonp;
                if (options.pingInterval !== undefined)
                    startOptions.pingInterval = options.pingInterval;
                if (angular.isDefined(options.withCredentials))
                    startOptions.withCredentials = options.withCredentials;
                if (queryParams)
...
//# sourceMappingURL=angular-signalr-hub.js.map 
//# sourceMappingURL=angular-signalr-hub.js.map